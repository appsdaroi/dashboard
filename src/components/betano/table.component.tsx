    ...
    return (
        <>
            ...
            <Flex alignItems="center" justifyContent="start" className="gap-3 mb-5">
                <Metric>Geren. usuários Betano</Metric>
                ...
                <Icon icon={ArrowUpRightIcon} variant="light" className="p-2 cursor-pointer" color="violet" tooltip="Abrir app" onClick={() => window.open("https://betano.appsdaroi.online/", '_blank')} />
            </Flex>
                            ...
                            <>
                                {
                                    data.response.data.map((item) => (
                                        <TableRow key={item.user_id}>
                                            ...
                                            <TableCell>{formatToCPF(item.cpf)}</TableCell>
                                            <TableCell>{CentsToReais(item.saldo_betano * 10000)}</TableCell>
