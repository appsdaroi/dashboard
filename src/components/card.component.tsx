...
const CardModule = ({ title, image, link }: CardModuleProps) => {
    return (
        <Link style={{ backgroundImage: `url(${image})` }} className="relative w-full bg-center bg-cover rounded-[15px] aspect-[182/227] group/card overflow-hidden hover:shadow-lg hover:scale-105 hover:shadow-slate-400/50 transition-all" href={link}>
